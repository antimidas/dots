...
//voice/extensions/linkification/voice_options_controller.closure.js
goog.loadModule(function(exports) {'use strict';/**
 * @fileoverview added by tsickle
 * Generated from: voice/extensions/linkification/voice_options_controller.ts
 * @suppress {checkTypes,const,extraRequire,missingOverride,missingRequire,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
goog.module('google3.voice.extensions.linkification.voice_options_controller');
var module = module || { id: 'voice/extensions/linkification/voice_options_controller.closure.js' };
goog.require('google3.third_party.javascript.tslib.tslib');
const tsickle_voice_storage_1 = goog.requireType("google3.voice.extensions.linkification.voice_storage");
const voice_storage_1 = goog.require('google3.voice.extensions.linkification.voice_storage');
/**
 * View controller for option page UI.
 */
class VoiceOptionsController {
    constructor() {
        this.voiceStorage = voice_storage_1.VoiceStorage.getInstance();
        this.defaultRegionEl = (/** @type {!HTMLInputElement} */ (document.getElementsByClassName('voiceDefaultRegion')[0]));
        this.enableLinkificationEl = (/** @type {!HTMLInputElement} */ (document.getElementsByClassName('voiceEnableLinkification')[0]));
    }
    /**
     * @private
     * @return {void}
    ...
    changeDefaultRegion() {
        /** @type {string} */
        const newValue = this.defaultRegionEl.value;
        this.voiceStorage.setDefaultRegion(newValue);
    }
    /**
     * @private
     * @return {void}
     */
    changeEnableLinkification() {
        /** @type {boolean} */
        const newValue = this.enableLinkificationEl.checked;
        this.voiceStorage.setShouldEnableLinkifiction(newValue);
    }
    /**
     * @public
     * @return {!Promise<void>}
    ...
    async init() {
        /** @type {string} */
        const defaultRegion = await this.voiceStorage.getDefaultRegion();
        /** @type {boolean} */
        const shouldEnableLinkifiction = await this.voiceStorage.getShouldEnableLinkifiction();
        this.defaultRegionEl.value = defaultRegion;
        this.enableLinkificationEl.checked = shouldEnableLinkifiction;
        this.defaultRegionEl.addEventListener('change', (/**
         * @return {void}
         */
        () => {
            this.changeDefaultRegion();
        }));
        this.enableLinkificationEl.addEventListener('change', (/**
         * @return {void}
         */
        () => {
            this.changeEnableLinkification();
        }));
    }
}
exports.VoiceOptionsController = VoiceOptionsController;
/* istanbul ignore if */
if (false) {
    /**
     * @type {!tsickle_voice_storage_1.VoiceStorage}
     * @private
     */
    VoiceOptionsController.prototype.voiceStorage;
    /**
     * @type {!HTMLInputElement}
     * @private
     */
    VoiceOptionsController.prototype.defaultRegionEl;
    /**
     * @type {!HTMLInputElement}
     * @private
     */
    VoiceOptionsController.prototype.enableLinkificationEl;
}
//# sourceMappingURL=data:application/json;base64,
;return exports;});

//voice/extensions/linkification/options.closure.js
goog.loadModule(function(exports) {'use strict';/**
 * @fileoverview added by tsickle
 * Generated from: voice/extensions/linkification/options.ts
 * @suppress {checkTypes,const,extraRequire,missingOverride,missingRequire,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
goog.module('google3.voice.extensions.linkification.options');
var module = module || { id: 'voice/extensions/linkification/options.closure.js' };
goog.require('google3.third_party.javascript.tslib.tslib');
const tsickle_voice_options_controller_1 = goog.requireType("google3.voice.extensions.linkification.voice_options_controller");
const voice_options_controller_1 = goog.require('google3.voice.extensions.linkification.voice_options_controller');
/** @type {!tsickle_voice_options_controller_1.VoiceOptionsController} */
const voiceOptionsController = new voice_options_controller_1.VoiceOptionsController();
voiceOptionsController.init();
//# sourceMappingURL=data:application/json;base64,
;return exports;});
